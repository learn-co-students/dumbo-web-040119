...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { ferociousness: @species.ferociousness, name: @species.name, vegetarian: @species.vegetarian } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { ferociousness: @species.ferociousness, name: @species.name, vegetarian: @species.vegetarian } }
